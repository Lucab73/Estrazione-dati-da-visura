...
with st.sidebar:
    ...
    st.divider ()
    st.markdown ("<div style='font-size: 20px;'><strong>🔄 Versione:</strong> 1.2</div>", unsafe_allow_html=True)
    st.markdown ("<div style='font-size: 20px;'><strong>👨‍💻 Sviluppato da:</strong> Luca Bruzzi</div>",
                 unsafe_allow_html=True)